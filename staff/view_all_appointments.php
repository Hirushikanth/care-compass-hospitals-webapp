...
$appointments = $db->getAllAppointments(); // You need to add this function to db.php
?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <?php if ($appointment['status'] == 'pending'): ?>
                                                <a href="confirm_appointment.php?id=<?= $appointment['id'] ?>" class="btn btn-sm btn-primary"><i class="bi bi-check-lg"></i> Confirm</a>
